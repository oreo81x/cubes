...
// Notifies shared code that a window has lost || received input focus
//
...
// Notifies shared code that a window has been iconified || restored
//
...
// Notifies shared code that a window has been maximized || restored
//
